    ...
    <div class="card-body text-center">
        ...
        <form action="{{ route('adminLogin.store') }}" method="POST">
            ...
            <div class="mb-3 text-start">
                ...
                <input type="email" name="email" class="form-control" id="email" placeholder="staff@noun.edu.ng" value="{{ old('email') }}" required>
            </div>
        ...
        <div class="mt-3">
            ...
            <a href="/adminRegister" class="text-decoration-none small text-muted">Sign Up</a>
        </div>
    </div>
</div>
